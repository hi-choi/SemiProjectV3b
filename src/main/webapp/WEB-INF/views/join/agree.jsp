...
<!-- Section Title -->
            <div>
                <h2>사이트 약관 동의</h2>
                <small class="text-muted">회원가입을 위해서 아래 사이트 이용약관&middot;개인정보 수집 및 이용에 대한 안내를
                  읽고 동의해 주세요
                </small>
                <hr>
            </div>
            ...
            <div class="card card-body bg-light">
                  ...
                  <form name="agreefrm" id="agreefrm">
                    <div class="form-group">
                        <textarea rows="10" class="form-control text-danger border-danger">
                        카카오계정 약관
