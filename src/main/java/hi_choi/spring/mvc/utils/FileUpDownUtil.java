package hi_choi.spring.mvc.utils;
    ...
    public void procDownload(String fname, String uuid, HttpServletResponse res){
        ...
        try {
            ...
            if (!skip) { //다운로드할 파일이 존재한다면
                ...
                // 파일명이 한글인 경우 제대로 표시할 수 있도록 utf-8로 반환
                res.setHeader("Content-Disposition","attachment; filename=\"" + fname + "\"");
                res.setHeader("Content-Type","application/octest-stream; charset=utf-8");
